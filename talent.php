				...
				<div class="container-fluid">
				  ...
				  <div id="navbar" class="navbar-collapse collapse">
					...
					<ul class="nav navbar-nav navbar-right">
					  <li class="active"><a href="universityNotification.php" onclick ="decrease();">Notifications <span class="sr-only">(current)</span><span class="custom_bubble" style="display:none"></span></a></li>
