				...
				<div class="container-fluid">
					...
					<div id="navbar" class="navbar-collapse collapse">
						...
						<ul class="nav navbar-nav navbar-right">
							<li>
								<a href="universityNotification.php" onclick ="decrease();">Notifications<span class="custom_bubble"></span></a>
							</li>
						...
						<div id="talent-panel-content" class="tab-pane fade active in">
							<div class="col-md-10 col-lg-8" id="userList">
								<ul class="nav nav-pills nav-stacked" id="chat-user-list">
									<li class="active" id = "startChat"><a href="#" data-toggle="tab"><img alt="avatar" src="./img/user_logo.jpg" /> sadas&nbsp;&nbsp;&nbsp;<span class="unread">2 unread messages</span></a></li>
									<li><a href="#" data-toggle="tab"><img alt="avatar" src="./img/user_logo.jpg" /> grsa</a></li>
									<li><a href="#" data-toggle="tab"><img alt="avatar" src="./img/user_logo.jpg" /> kslhg</a></li>
									<li><a href="#" data-toggle="tab"><img alt="avatar" src="./img/user_logo.jpg" /> abc , def</a></li>
									<li><a href="#" data-toggle="tab"><img alt="avatar" src="./img/user_logo.jpg" /> testing10</a></li>
									<li><a href="#" data-toggle="tab"><img alt="avatar" src="./img/user_logo.jpg" /> testing8</a></li>
								</ul>
							</div>
